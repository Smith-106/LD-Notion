...
- **Test**: Vitest 4.x (479 tests, tests/ + tests/setup.js); legacy node tests (utils/logic-modules/notion-oauth)
...
---
*Last updated: 2026-07-28 (drift-realign: ISS-012 AI trace 全量持久化 + ISS-013 arch-013 接缝 4 处迁移，测试 441→479)*
