...
// ISS-20260723-010 W3 (ARCH-005): LinuxDoAPI 定义已迁回 extract 层（src/extract/LinuxDoAPI.js），
// 消除 adapter→export 逆向依赖。此处从 extract re-export 保持消费点契约不变（7 处
// require("../export") 取 LinuxDoAPI 零改动，符合 review spec「分层重构验证：源码分层
// 与 esbuild 工厂内联正交」——源码层 export 不再定义该对象，分层目标即达成）。
