...
const { AIService } = require("./ai-service"); // M3: 提取自本文件(ai/ai-service.js),反向 require 再导出
...
// ═══════════════════════════════════════════════════════
const { QUICK_INTENT_PATTERNS, QUICK_INTENT_RULES } = require("./quick-intent"); // M3 波次6: 提取至 ai/quick-intent.js
...
// ═══════════════════════════════════════════════════════
// M3 波次4 (ISS-016): AI_WELCOME_ENTRY_POINTS/AIWelcomeUI/ChatUI 迁 src/ui/ai-chat-ui.js 消层级倒置,
// 反向 require 再导出保持对外契约(AIWelcomeUI/ChatUI 仍由 ai/index 暴露,panel-template/main-ui 消费)。
const { AI_WELCOME_ENTRY_POINTS, AIWelcomeUI, ChatUI } = require("../ui/ai-chat-ui");


// M3 波次5: AIClassifier 提取至 src/ai/ai-classifier.js,反向 require 再导出。
